...
最初にそもそもアニメーションとはなんでしょうか？
*アニメーションとは生命の無いものが作者の意図によって生きているように動かされた映画もしくその手法*とあります。UIのアニメーションも生きているようにまでいかなくても、例えばボールを地面に落とせば弾むように実際に存在するような表現を取り入れることで、ユーザーがより自然に動きを認識できるようになります。
